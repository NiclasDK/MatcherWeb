...
namespace ITMatcherWeb.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Available,ActivelySeeking,AcceptedUseOfData,ExpectedHourlySalary,Gender,DateOfBirth,FirstName,LastName,JobExperienceId,LanguageId,CertificateId,Email,EmailConfirmed,PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName")] Users users)
        {
